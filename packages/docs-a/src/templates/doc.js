...
import { DocTags, DocInfo, PageContext, DocContent } from "@m00n/docs-ui";
  ...
  render() {
    ...
    return (
      <PageContext.Provider value={{ data, config }}>
        <DocLayout location={location} tableOfContents={doc.tableOfContents} title={doc.frontmatter.title} >
          <Helmet>
