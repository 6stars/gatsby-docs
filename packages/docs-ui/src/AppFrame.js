          ...
          return (
            <div className={classes.root}>
                ...
                <Toolbar>
                  ...
                  {title !== null && (
                    <Typography className={classes.title} variant="h5" color="inherit" noWrap>
                      {data.currentPage && data.currentPage.edges.length > 0 && data.currentPage.edges[0].node.context && data.currentPage.edges[0].node.context.title != null ? data.currentPage.edges[0].node.context.title : DEFAULT_PAGE_TITLE}
                    </Typography>
                  )}
              ...
              {this.props.tableOfContents ?
                <AppTableOfContents className={classes.drawer}
                  disablePermanent={disablePermanent}
                  onClose={this.handleDrawerClose}
                  onOpen={this.handleDrawerOpen}
                  mobileOpen={this.state.mobileOpen}
                  toc={this.props.tableOfContents} title={this.props.title}
                /> : null
              }
              {children}
            </div>
