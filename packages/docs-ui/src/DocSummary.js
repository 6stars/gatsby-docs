...
class DocSummary extends Component {
  ...
  render() {
    ...
    const { path, tags, category, description, title, formattedDate, timeToRead, slug, cover, excerpt } = docInfo;
      ...
      <Card className={classes.card}>
        <CardHeader
          ...
          action={
            <Tooltip title="Edit this Doc" placement="top">
              <IconButton href={`${ADMIN_EDIT_PAGE_URL}${slug}`} target="_blank" aria-label="EditDoc">
                <EditIcon />
              </IconButton>
            </Tooltip>
        ...
        {!coverIsImg &&
          <div className={classes.coverTitle}>
            <Typography component="h2" variant="h3" color="secondary" gutterBottom={true}>
              {cover}
            </Typography>
          </div>
        } 
